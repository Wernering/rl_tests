...
class AIGame:
    ...
    def save_iteration(self):
        self.df_iter_cycle = self.df_iter_cycle.append(
            pd.Series([self.total_iterations, self.total_cycles], index=self.df_iter_cycle.columns),
            ignore_index=True,
        )

    def save_cycle(self):
        self.df_cycle_steps = self.df_cycle_steps.append(
            pd.Series([self.total_cycles, self.cycle_iterations], index=self.df_cycle_steps.columns),
            ignore_index=True,
        )
