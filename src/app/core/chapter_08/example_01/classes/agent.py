...
class Agent:
    ...
    def update_model(self, state_s: tuple, action: int, reward: int, state_s1: tuple) -> None:
    ...
    def model_learning(self) -> None:
        for _ in range(self.steps):
            ...
            self.update_expected_value(state_s=state, action=action, reward=reward, state_s1=state_s)
